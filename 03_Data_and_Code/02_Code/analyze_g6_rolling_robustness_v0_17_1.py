...
pd.DataFrame(rows).to_csv(OUT/'G6_ROLLING_ROBUSTNESS_RANKS_v0_17_1.csv',index=False)
...
pd.DataFrame(bestrows).to_csv(OUT/'G6_ROLLING_BEST_SLEEVE_FREQUENCY_v0_17_1.csv',index=False)
