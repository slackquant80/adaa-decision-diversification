...
MAP={
'HAA':('G2_HAA_TARGET_WEIGHTS_R_v0_11.csv','G2_HAA_TARGET_WEIGHTS_INDEPENDENT_v0_11.csv'),
'BAA_Aggressive':('G2_BAA_AGGRESSIVE_TARGET_WEIGHTS_R_v0_11.csv','G2_BAA_AGGRESSIVE_TARGET_WEIGHTS_INDEPENDENT_v0_11.csv'),
'ADM':('G2_ADM_TARGET_WEIGHTS_R_v0_11.csv','G2_ADM_TARGET_WEIGHTS_INDEPENDENT_v0_11.csv'),
'FAA_legacy':('G2_FAA_LEGACY_TARGET_WEIGHTS_R_v0_11.csv','G2_FAA_LEGACY_TARGET_WEIGHTS_INDEPENDENT_v0_11.csv'),
'LAA':('G2_LAA_TARGET_WEIGHTS_R_v0_11.csv','G2_LAA_TARGET_WEIGHTS_INDEPENDENT_v0_11.csv')}
...
def main():
    ...
    summary=pd.DataFrame(rows); summary.to_csv(out/'G2_R_PYTHON_TARGET_WEIGHT_EQUIVALENCE_v0_11.csv',index=False)
    pd.DataFrame(diffs).to_csv(out/'G2_R_PYTHON_TARGET_WEIGHT_DIFF_DETAIL_v0_11.csv',index=False)
    rec={'version':'v0.11','all_pass':bool(summary['pass'].all()),'performance_blind':True,'headline_performance_computed':False,'sleeves':rows}
    (out/'G2_R_PYTHON_TARGET_WEIGHT_EQUIVALENCE_RECORD_v0_11.json').write_text(json.dumps(rec,indent=2),encoding='utf-8')
